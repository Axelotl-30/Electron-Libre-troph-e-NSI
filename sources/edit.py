...
def drag(self, x1, y1):
    ...
    if not px.btn(px.MOUSE_BUTTON_LEFT):
        ...
        dipole = {"start": (start[0], start[1]), "end": (end[0], end[1]), "type": (y1-8)//28, "hitbox": (0,0,0,0),"rotate": self.rotate, "variant/color": 1, "U": 9 if ((y1-8)//28) == 0 else 0, "I": None, "R": 10, "visited": False}
